...
export const createSkillAssessmentSchema = z.object({
  ...
  level: z.enum(['Expert', 'Advanced', 'Proficient', 'Intermediate', 'Foundational', 'Beginner', 'Awareness', 'Unset']).default('Unset'),
...
export const approveSkillAssessmentSchema = z.object({
  level: z.enum(['Expert', 'Advanced', 'Proficient', 'Intermediate', 'Foundational', 'Beginner', 'Awareness', 'Unset']).optional(),
